...
# FOR README: include Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass
    ...
    Switch($yn.ToLower())
    {
        ...
        if (Test-Path -Path $Folder) {
            ...
            if ($updateStable -eq 1){ # nest for updateStable
                ...
                Invoke-WebRequest -uri "https://github.com/Eldeston/Super-Duper-Vanilla/archive/refs/tags/v1.3.5-beta.3.zip" -OutFile ( New-Item -Path "super-duper-vanilla_stable.zip" -Force ) 
          ...
          # -intentionally left blank
            ...
            if ($updateStable -eq 3){
                ...
                Write-Host "    │ ╱╲ │" -ForegroundColor Red -NoNewline
                Write-Host "  No changes were made on your computer."
                Write-Host "    └────┘" -ForegroundColor Red
                Start-Sleep -Seconds 0.50
                Write-Host
                Start-Sleep -Seconds 0.50
